...
const ShopContent = () => {
  ...
  return (
    <section className="max-w-7xl w-full min-h-[70vh] mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 overflow-x-hidden">
