  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-[95vw] sm:max-w-5xl h-[95dvh] sm:h-[90vh] flex flex-col p-0 bg-white shadow-xl border rounded-xl mx-auto"
      >
        {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                ...
                >
                  <span className="capitalize text-xs sm:text-lg">
                    {orderData.status}
                  </span>
                </Badge>
                <Badge
            ...
            <div className="border-b px-4 sm:px-6">
              <TabsList className="grid w-full grid-cols-3">
                <TabsTrigger
                  value="details"
                  className={cn(
                    "text-xs sm:text-sm flex items-center gap-2 rounded-none px-3 py-2 transition-colors duration-200",
                      ...
                      <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {orderData.status === "processing" && (
                            <Button className="bg-[#0d97d9] hover:bg-[#1e79bd] h-10 text-sm text-white">
                          ...
                          {orderData.paymentStatus === "pending" &&
                            orderData.paymentMethod === "cod" && (
                              <Button className="bg-green-600 hover:bg-green-700 h-10 text-sm text-white">
        ...
        <div className="border-t p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-center">
            <div className="text-sm text-gray-600">
              Need help? Contact{" "}
              <span className="text-primary">support@bazaar.com</span>
            </div>
