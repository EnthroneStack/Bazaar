    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md w-full">
          ...
          <Link href="/shop">
            <Button className="w-full sm:w-auto">Back to Shop</Button>
          </Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
          <nav className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-600 flex-wrap">
            <Link href="/" className="hover:text-gray-900 truncate">
              Home
            </Link>
            <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />

            <Link href="/shop" className="hover:text-gray-900 truncate">
              Shop
            </Link>
            <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        {/* Product Section - Fixed overflow */}
        <div className="bg-white border-gray-400 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 mb-6 sm:mb-8 overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 p-3 sm:p-4 lg:p-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {/* Thumbnail Images - Fixed overflow */}
              <div className="flex gap-2 overflow-x-auto pb-2 -mx-1 px-1">
                {product?.images.map((image, index) => (
                  <button
                    key={index}
                    onClick={() => setSelectedImage(index)}
                    className={`shrink-0 w-16 h-16 sm:w-20 sm:h-20 border-2 rounded-lg overflow-hidden ${
                      selectedImage === index
                        ? "border-primary"
                        : "border-gray-200"
                    }`}
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-3 sm:mb-4">
                  <StarRating rating={rating} size="md" showRating />
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-3">
                  <Button
                    onClick={handleAddToCart}
                    disabled={!product.inStock || isAddingToCart}
                    className="w-full bg-primary text-white py-3 px-4 sm:px-6 rounded-lg font-medium flex items-center justify-center space-x-2 shadow-xl hover:shadow-2xl transition-colors duration-300"
                  >
                    {isAddingToCart ? (
                      <>
                        <div className="h-5 w-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
                  ...
                  <Button
                    onClick={handleWhatsAppOrder}
                    disabled={!product.inStock || isOrderingViaWhatsApp}
                    className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-4 sm:px-6 rounded-lg font-medium shadow-xl hover:shadow-2xl transition-colors duration-300 flex items-center justify-center space-x-2"
                  >
                    {isOrderingViaWhatsApp ? (
                      <>
                        <div className="h-5 w-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="outline"
                      className="flex-1 p-3 border-gray-300 hover:bg-gray-50 shadow-xl hover:shadow-2xl transition-colors duration-300"
                    >
                      <Heart className="h-5 w-5" />
                    </Button>
                    <Button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-400">
        ...
        {/* Product Details Tabs - Scrollable on mobile */}
            ...
            <nav className="flex space-x-4 sm:space-x-8 px-3 sm:px-6 min-w-max sm:min-w-0">
              {[
                ...
                <button
                  key={tab.id}
                  onClick={() => setActiveTab(tab.id)}
                  className={`py-3 sm:py-4 px-1 border-b-2 font-medium text-xs sm:text-sm cursor-pointer whitespace-nowrap ${
                    activeTab === tab.id
                      ? "border-primary text-primary"
                      : "border-transparent text-gray-500 hover:text-gray-700"
                  }`}
            ...
            {activeTab === "specifications" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <dl className="space-y-2">
                    <div className="flex justify-between">
                      <dt className="text-gray-600 text-sm sm:text-base">
                        Brand
                      </dt>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      <Button
                        onClick={handleWhatsAppOrder}
                        className="w-full bg-green-600 hover:bg-green-700 text-white flex items-center justify-center space-x-2 py-2 sm:py-3"
                      >
                        <MessageCircle className="h-4 w-4 sm:h-5 sm:w-5" />
        ...
        {relatedProducts.length > 0 && (
          <section className="mb-8 sm:mb-12">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-2">
              ...
              <Link
                href={`/shop?category=${product.category}`}
                className="text-primary hover:text-primary-600 font-medium flex items-center space-x-1 text-sm sm:text-base"
              >
                <span>View All</span>
                <ChevronRight className="h-4 w-4" />
              </Link>
