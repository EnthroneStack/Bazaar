    ...
    <header className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          {/* RESPONSIVE CHANGE: Show store name on mobile */}
          <div className="sm:hidden">
            <h2 className="text-base font-semibold text-gray-900 truncate max-w-[150px]">
              {storeName}
            </h2>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          {/* RESPONSIVE CHANGE: Search icon on mobile, full search on desktop */}
