...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Header - RESPONSIVE CHANGE: Stack on mobile, flex on desktop */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:space-x-4">
          ...
          <button className="w-full sm:w-auto border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 text-sm flex items-center justify-center">
            <Download className="h-4 w-4 mr-2" />
            Export
          </button>
        </div>
      ...
      {/* Metrics Grid - RESPONSIVE CHANGE: 1 column mobile, 2 tablet, 4 desktop */}
      ...
      {/* Charts and Data Grid - RESPONSIVE CHANGE: Stack on mobile, 2/1 split on tablet/desktop */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Revenue Chart */}
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
          ...
          {/* RESPONSIVE CHANGE: Adjust chart height for mobile */}
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
          <h3 className="font-semibold text-gray-900 mb-4 sm:mb-6">
            Top Products
          </h3>
