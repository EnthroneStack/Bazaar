                        ...
                        <ul className="mt-2 space-y-1 text-sm text-red-600">
                          ...
                          {product.status === "PUBLISHED" && (
                            <li className="font-semibold">
                              • Product will no longer be accessible to
                              customers
                            </li>
                          )}
                        </ul>
                      ...
                      {product.sales > 0 && (
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                          ...
                          <p className="text-sm text-amber-600 mt-1">
                            This product has {product.sales} sales. Deleting it
                            will remove all sales history.
                          </p>
                        </div>
                      )}
                    </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {product.sales > 0 && (
                          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                            ...
                            <p className="text-sm text-amber-600 mt-1">
                              This product has {product.sales} sales. Deleting
                              it will remove all sales history.
                            </p>
                          </div>
                        )}
                      </div>
