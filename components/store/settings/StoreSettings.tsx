...
export default function StoreSettings() {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      {/* RESPONSIVE CHANGE: Scrollable tabs on mobile */}
      <div className="border-b border-gray-200">
        <nav className="flex overflow-x-auto">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            return (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`flex items-center px-3 sm:px-6 py-3 text-xs sm:text-sm font-medium border-b-2 transition-colors flex-shrink-0 ${
                  activeTab === tab.id
                    ? "border-blue-500 text-blue-600"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                }`}
      ...
      <div className="p-4 sm:p-6">
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={settings.storeEmail}
                      onChange={(e) =>
                        handleDirectChange("storeEmail", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={settings.storePhone}
                      onChange={(e) =>
                        handleDirectChange("storePhone", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                  <div>
                    ...
                    <select
                      value={settings.currency}
                      onChange={(e) =>
                        handleDirectChange("currency", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    >
                      <option value="USD">US Dollar (USD)</option>
                  ...
                  <div>
                    ...
                    <select
                      value={settings.timezone}
                      onChange={(e) =>
                        handleDirectChange("timezone", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    >
                  ...
                  <div>
                    ...
                    <select
                      value={settings.dateFormat}
                      onChange={(e) =>
                        handleDirectChange("dateFormat", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    >
                      <option value="MM/DD/YYYY">MM/DD/YYYY</option>
                  ...
                  <div>
                    ...
                    <select
                      value={settings.language}
                      onChange={(e) =>
                        handleDirectChange("language", e.target.value)
                      }
                      className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    >
                      <option value="en">English</option>
                    ...
                    ([method, enabled]) => (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="font-medium text-gray-900 text-sm sm:text-base capitalize">
                              {method.replace(/([A-Z])/g, " $1").trim()}
                            </div>
          ...
          {/* Save Button - RESPONSIVE CHANGE: Fixed at bottom on mobile */}
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
            <div className="flex items-center justify-end">
              <button
                onClick={handleSaveSettings}
                className="w-full sm:w-auto bg-blue-600 text-white px-4 sm:px-6 py-3 rounded-lg hover:bg-blue-700 flex items-center justify-center text-sm sm:text-base"
              >
